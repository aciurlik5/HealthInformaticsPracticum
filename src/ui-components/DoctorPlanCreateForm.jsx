...
import { createDoctorPlan } from "../graphql/mutations";
export default function DoctorPlanCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setSendSleep(initialValues.sendSleep);
    setSendAlcohol(initialValues.sendAlcohol);
    setSendPA(initialValues.sendPA);
    setConcern(initialValues.concern);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createDoctorPlan.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "DoctorPlanCreateForm")}
      {...rest}
    >
      <TextField
        label="Date"
