...
import { createFhirId } from "../graphql/mutations";
export default function FhirIdCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setFhirId(initialValues.FhirId);
    setErrors({});
  };
  const validations = {
    email: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createFhirId.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "FhirIdCreateForm")}
      {...rest}
    >
      <TextField
        label="Email"
